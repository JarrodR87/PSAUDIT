...
$ErrorActionPreference= 'silentlycontinue'
    ...
    PROCESS {
        ...
        $FileOwnershipChanges = Get-WinEvent -FilterHashtable @{LogName = "Security"; ID = 4674 } | Where-Object -FilterScript { $_.Message -like "*.evtx*" -and $_.Message -like "*WRITE_OWNER*" } | ConvertTo-Html -Fragment
